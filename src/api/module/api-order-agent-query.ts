...
export type QueryAgentOrderParams = {
  /** 请求对象*/
  orderReq: {
    /** 页码*/
    pageIndex: number
    ...
    /** 开始时间 格式yyyy-MM-dd HH:mm:ss，与endTime间隔不超过5分钟*/
    startTime: string

    /** 结束时间 格式yyyy-MM-dd HH:mm:ss，与startTime间隔不超过5分钟*/
    endTime: string
...
export class QueryAgentOrderAPI extends JdUnionBase {
  async queryAgentOrder(params: QueryAgentOrderParams) {
    return this.execute<QueryAgentOrderResult>(
