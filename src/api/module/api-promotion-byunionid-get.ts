...
export type GetByunionidPromotionParams = {
  /** 请求入参*/
  promotionCodeReq: {
...
export type GetByunionidPromotionResult = {
  /** 返回码*/
  code: number
...
export class GetByunionidPromotionAPI extends JdUnionBase {
  async getByunionidPromotion(params: GetByunionidPromotionParams) {
    return this.execute<GetByunionidPromotionResult>(
